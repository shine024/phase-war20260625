...
func _init_faction_list() -> void:
	...
	for faction_info in all_factions:
		...
		item_button.add_theme_color_override("font_hover_color", DT.COLOR_HOVER_WHITE)
		item_button.add_theme_color_override("font_pressed_color", DT.COLOR_HOVER_WHITE)
		item_button.add_theme_color_override("font_focus_color", DT.COLOR_HOVER_WHITE)
...
func _update_faction_detail() -> void:
	...
	active_btn.add_theme_color_override("font_hover_color", DT.COLOR_HOVER_WHITE)
	active_btn.add_theme_color_override("font_pressed_color", DT.COLOR_HOVER_WHITE)
	active_btn.add_theme_color_override("font_focus_color", DT.COLOR_HOVER_WHITE)
...
func _make_faction_skill_node(skill: Dictionary, faction_id: String, faction_level: int, unlocked: Array, avail: int, conflict_id: String) -> PanelContainer:
	...
	if is_unlocked:
		...
		unlock_btn.add_theme_color_override("font_hover_color", DT.COLOR_HOVER_WHITE)
		unlock_btn.add_theme_color_override("font_pressed_color", DT.COLOR_HOVER_WHITE)
		unlock_btn.add_theme_color_override("font_focus_color", DT.COLOR_HOVER_WHITE)
