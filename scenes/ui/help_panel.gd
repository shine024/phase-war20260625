...
- 在成长面板中选择你拥有的卡牌
- 通过战斗获取经验自动升级（Lv1-30），每5级解锁词条
- 消耗纳米材料提升强化等级（Lv1-10），进一步增益属性
...
[b][color=#88ccff]◆ 养成三维度[/color][/b]
卡牌养成分三个独立维度：
- [color=#88ee88]战斗等级[/color]：通过战斗积累经验自动升级（Lv1-30），每5级获得词条
- [color=#cc88ff]强化等级[/color]：消耗纳米材料手动强化（Lv1-10），提供基础属性成长
- [color=#ffaa44]蓝图星级[/color]：按副本次数累计（0-9★），激活额外加成
