...
const SKILL_TREE: Dictionary = {
	...
	"nova_arms": [
		...
		{"id": "sk_nova_res1", "name": "战利品猎人", "desc": "战后经验+12%",
		 "tier": 3, "cost": 1, "branch": "B", "effect_type": "resource",
		 "effects": {"xp_bonus": 0.12}},
	...
	"aether_dynamics": [
		...
		{"id": "sk_aeth_res2", "name": "战场补给", "desc": "声望+15%",
	...
	"quantum_logistics": [
		...
		{"id": "sk_quant_res2", "name": "后勤专家", "desc": "经验+15%",
		 "tier": 4, "cost": 2, "branch": "B", "effect_type": "resource",
		 "effects": {"xp_bonus": 0.15}},
	...
	"helix_recon": [
		...
		{"id": "sk_helix_res1", "name": "情报收益", "desc": "声望+15%",
		 "tier": 3, "cost": 1, "branch": "B", "effect_type": "resource",
		 "effects": {"reputation_bonus": 0.15}},
	...
	"void_research": [
		...
		{"id": "sk_void_res1", "name": "虚空采集", "desc": "声望+15%",
		 "tier": 3, "cost": 1, "branch": "B", "effect_type": "resource",
		 "effects": {"reputation_bonus": 0.15}},
	...
	"frontier_union": [
		...
		{"id": "sk_front_res1", "name": "多面手", "desc": "声望+10%, 经验+10%",
		 "tier": 3, "cost": 1, "branch": "B", "effect_type": "resource",
		 "effects": {"reputation_bonus": 0.10, "xp_bonus": 0.10}},
