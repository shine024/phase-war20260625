...
const DATA: Dictionary = {
	...
	"arm_01_sloped_armor" = {
		...
		icon = "res://textures/icons/mods/arm_01_sloped_armor.png",
		rarity = "rare",
		cost_research = 180,
		cost_install = 90,
		slot_type = "armor",
	...
	"arm_02_composite_armor" = {
		...
		icon = "res://textures/icons/mods/arm_02_composite_armor.png",
		rarity = "epic",
		cost_research = 280,
		cost_install = 140,
		slot_type = "armor",
	...
	"arm_03_reactive_armor" = {
		...
		icon = "res://textures/icons/mods/arm_03_reactive_armor.png",
		rarity = "epic",
		cost_research = 300,
		cost_install = 150,
		slot_type = "armor",
	...
	"arm_04_aps" = {
		...
		icon = "res://textures/icons/mods/arm_04_aps.png",
		rarity = "legendary",
		cost_research = 450,
		cost_install = 225,
		slot_type = "active",
	...
	"arm_05_smoothbore" = {
		...
		icon = "res://textures/icons/mods/arm_05_smoothbore.png",
		rarity = "epic",
		cost_research = 260,
		cost_install = 130,
		slot_type = "gun",
	...
	"arm_06_apfsds" = {
		...
		icon = "res://textures/icons/mods/arm_06_apfsds.png",
		rarity = "epic",
		cost_research = 320,
		cost_install = 160,
	...
	"arm_07_gun_missile" = {
		...
		icon = "res://textures/icons/mods/arm_07_gun_missile.png",
		rarity = "legendary",
		cost_research = 400,
		cost_install = 200,
		slot_type = "gun",
	...
	"arm_08_autoloader" = {
		...
		icon = "res://textures/icons/mods/arm_08_autoloader.png",
		rarity = "epic",
		cost_research = 280,
		cost_install = 140,
	...
	"arm_09_turbine" = {
		...
		icon = "res://textures/icons/mods/arm_09_turbine.png",
		rarity = "legendary",
		cost_research = 380,
		cost_install = 190,
		slot_type = "engine",
	...
	"arm_10_diesel_turbo" = {
		...
		icon = "res://textures/icons/mods/arm_10_diesel_turbo.png",
		rarity = "epic",
		cost_research = 240,
		cost_install = 120,
		slot_type = "engine",
	...
	"arm_11_fire_control" = {
		...
		icon = "res://textures/icons/mods/arm_11_fire_control.png",
		rarity = "epic",
		cost_research = 300,
		cost_install = 150,
	...
	"arm_12_thermal_sight" = {
		...
		icon = "res://textures/icons/mods/arm_12_thermal_sight.png",
		rarity = "rare",
		cost_research = 200,
		cost_install = 100,
		slot_type = "optics",
	...
	"arm_13_deep_wading" = {
		...
		icon = "res://textures/icons/mods/arm_13_deep_wading.png",
		rarity = "uncommon",
		cost_research = 100,
		cost_install = 50,
	...
	"arm_14_mine_plow" = {
		...
		icon = "res://textures/icons/mods/arm_14_mine_plow.png",
		rarity = "rare",
		cost_research = 160,
		cost_install = 80,
	...
	"arm_15_data_link" = {
		...
		icon = "res://textures/icons/mods/arm_15_data_link.png",
		rarity = "epic",
		cost_research = 260,
		cost_install = 130,
		slot_type = "command",
