...
const DATA: Dictionary = {
	...
	"inf_02_assault_rifle" = {
		...
		icon = "res://textures/icons/mods/inf_02_assault_rifle.png",
		rarity = "rare",
		cost_research = 120,
		cost_install = 60,
		slot_type = "weapon",
	...
	"inf_03_small_caliber" = {
		...
		icon = "res://textures/icons/mods/inf_03_small_caliber.png",
		rarity = "rare",
		cost_research = 150,
		cost_install = 75,
		slot_type = "weapon",
	...
	"inf_04_bullpup" = {
		...
		icon = "res://textures/icons/mods/inf_04_bullpup.png",
		rarity = "rare",
		cost_research = 130,
		cost_install = 65,
		slot_type = "weapon",
	...
	"inf_06_hp_ammo" = {
		...
		icon = "res://textures/icons/mods/inf_06_hp_ammo.png",
		rarity = "epic",
		cost_research = 200,
		cost_install = 100,
		slot_type = "ammunition",
	...
	"inf_07_optical_scope" = {
		...
		icon = "res://textures/icons/mods/inf_07_optical_scope.png",
		rarity = "rare",
		cost_research = 140,
		cost_install = 70,
		slot_type = "optics",
	...
	"inf_08_holographic" = {
		...
		icon = "res://textures/icons/mods/inf_08_holographic.png",
		rarity = "rare",
		cost_research = 130,
		cost_install = 65,
		slot_type = "optics",
	...
	"inf_09_dual_mag" = {
		...
		icon = "res://textures/icons/mods/inf_09_dual_mag.png",
		rarity = "uncommon",
		cost_research = 80,
		cost_install = 40,
	...
	"inf_10_saw" = {
		...
		icon = "res://textures/icons/mods/inf_10_saw.png",
		rarity = "epic",
		cost_research = 250,
		cost_install = 125,
		slot_type = "weapon",
	...
	"inf_11_armor_insert" = {
		...
		icon = "res://textures/icons/mods/inf_11_armor_insert.png",
		rarity = "rare",
		cost_research = 160,
		cost_install = 80,
		slot_type = "armor",
	...
	"inf_12_body_armor" = {
		...
		icon = "res://textures/icons/mods/inf_12_body_armor.png",
		rarity = "rare",
		cost_research = 180,
		cost_install = 90,
		slot_type = "armor",
	...
	"inf_13_helmet_upgrade" = {
		...
		icon = "res://textures/icons/mods/inf_13_helmet_upgrade.png",
		rarity = "uncommon",
		cost_research = 100,
		cost_install = 50,
		slot_type = "helmet",
	...
	"inf_14_knee_pads" = {
		...
		icon = "res://textures/icons/mods/inf_14_knee_pads.png",
		rarity = "common",
		cost_research = 50,
		cost_install = 25,
		slot_type = "mobility",
	...
	"inf_15_riot_shield" = {
		...
		icon = "res://textures/icons/mods/inf_15_riot_shield.png",
		rarity = "epic",
		cost_research = 220,
		cost_install = 110,
		slot_type = "shield",
	...
	"inf_16_exoskeleton" = {
		...
		icon = "res://textures/icons/mods/inf_16_exoskeleton.png",
		rarity = "legendary",
		cost_research = 400,
		cost_install = 200,
	...
	"inf_17_tourniquet" = {
		...
		icon = "res://textures/icons/mods/inf_17_tourniquet.png",
		rarity = "uncommon",
		cost_research = 60,
		cost_install = 30,
		slot_type = "medical",
	...
	"inf_18_ifak" = {
		...
		icon = "res://textures/icons/mods/inf_18_ifak.png",
		rarity = "rare",
		cost_research = 120,
		cost_install = 60,
		slot_type = "medical",
	...
	"inf_19_radio" = {
		...
		icon = "res://textures/icons/mods/inf_19_radio.png",
		rarity = "rare",
		cost_research = 140,
		cost_install = 70,
		slot_type = "comms",
	...
	"inf_20_night_vision" = {
		...
		icon = "res://textures/icons/mods/inf_20_night_vision.png",
		rarity = "rare",
		cost_research = 160,
		cost_install = 80,
		slot_type = "optics",
	...
	"inf_21_thermal" = {
		...
		icon = "res://textures/icons/mods/inf_21_thermal.png",
		rarity = "epic",
		cost_research = 240,
		cost_install = 120,
		slot_type = "optics",
	...
	"inf_22_breaching" = {
		...
		icon = "res://textures/icons/mods/inf_22_breaching.png",
		rarity = "uncommon",
		cost_research = 70,
		cost_install = 35,
