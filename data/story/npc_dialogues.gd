...
const DIALOGUES: Dictionary = {
	...
	NPC_HELEN: [
		...
		},
		{
			...
			"lines": [
				{"speaker": "海伦", "text": "E-10947。相位之主应该已经告诉你一些事了。现在，由我亲口说出来。"},
				{"speaker": "海伦", "text": "入侵是真实的。5742次重启，也是真实的——每一次，都是我把时间线拉回来的。那个叫真实者的人，他只是不敢面对这个事实。"},
				{"speaker": "陈末", "text": "那你呢，海伦？你的声音……第90关那次，我听见了两个声音。"},
				{"speaker": "海伦", "text": "（声音出现片刻的失真）……因为我不再是完整的人类了。"},
				{"speaker": "海伦", "text": "很久以前，我是这座城市的指挥官——传奇指挥官海伦。当入侵第一次撕开裂口，我带人扛了三年。但人类的身体扛不住那么久。"},
				{"speaker": "海伦", "text": "最后，我放弃了肉体，把自己的意识与城市系统融合。从那以后，这座城的每一声播报，都是我残留的意识在燃烧。"},
				{"speaker": "陈末", "text": "你……为了我们，放弃了自己的生命？"},
				{"speaker": "海伦", "text": "为了守住你们。你打败了异虫，但裂口没有关闭——它还在撕开。我设计的双重跳跃，是为了把像你这样的通关者的战力保存到下一次循环。"},
				{"speaker": "海伦", "text": "直到有人能彻底关上那道裂口。E-10947——也许那个人就是你。双重跳跃协议已就绪，选择权在你。"},
			],
