...
## v7.x: drop_rate_bonus（掉落率加成）奖励已移除——该字段从未被掉落生成逻辑消费（空转）。
...
const REVEAL_EVENTS: Dictionary = {
	...
	"infantry_1": {
		"title": "深入分析·步兵战术",
		"desc": "获取步兵的完整属性与技能列表：手榴弹、战壕挖掘、掩护射击等。解锁完整属性与技能。",
		"rewards": [
	...
	"flame_1": {
		"title": "深入分析·火焰战术",
		"desc": "掌握火焰兵完整参数与技能：持续灼烧、范围喷射、死亡燃料爆炸。解锁完整属性与技能。",
		"rewards": [
			{"type": "stat_visibility", "value": "full_stats"},
			{"type": "stat_visibility", "value": "skill_list"},
		],
	...
	"heavy_armor_1": {
		"title": "深入分析·重装甲战术",
		"desc": "掌握重装甲完整参数与技能：主炮轰击、碾压冲锋、紧急维修。解锁完整属性与技能。",
		"rewards": [
			{"type": "stat_visibility", "value": "full_stats"},
			{"type": "stat_visibility", "value": "skill_list"},
		],
	...
	"artillery_1": {
		"title": "深入分析·火炮战术",
		"desc": "掌握火炮完整参数与技能：曲射炮击、烟雾遮蔽、集束炸弹。解锁完整属性与技能。",
		"rewards": [
			{"type": "stat_visibility", "value": "full_stats"},
			{"type": "stat_visibility", "value": "skill_list"},
		],
	...
	"stealth_1": {
		"title": "深入分析·隐匿战术",
		"desc": "掌握隐匿完整参数与技能：光学迷彩、瞬移突击、后背刺杀。解锁完整属性与技能。",
		"rewards": [
			{"type": "stat_visibility", "value": "full_stats"},
			{"type": "stat_visibility", "value": "skill_list"},
		],
	...
	"boss_nano_1": {
		"title": "深入分析·纳米核心战术",
		"desc": "掌握纳米核心完整参数与技能：纳米脉冲波、自修复场、纳米吞噬、相位转换。解锁完整属性。",
		"rewards": [
			{"type": "stat_visibility", "value": "full_stats"},
			{"type": "stat_visibility", "value": "skill_list"},
		],
	...
	"air_1": {
		"title": "深入分析·空中战术",
		"desc": "掌握空中单位完整参数与技能：俯冲轰炸、空对地导弹、电子干扰。解锁完整属性与技能。",
		"rewards": [
			{"type": "stat_visibility", "value": "full_stats"},
			{"type": "stat_visibility", "value": "skill_list"},
		],
