...
const MOD_DATA: Dictionary = {
	...
	"MOD_05": {"id": "MOD_05", "name": "穿甲专精",   "desc": "曲射+30%,直射-10%",      "type": "attack",   "power_mult": 1.30,
		"attack_multiplier": 1.30, "condition_type": "vs_armor",
		"effects": {"armor_bonus": 0.30, "light_penalty": -0.10}},
	"MOD_06": {"id": "MOD_06", "name": "高爆专精",   "desc": "直射+30%,曲射-10%",      "type": "attack",   "power_mult": 1.30,
		"attack_multiplier": 1.30, "condition_type": "vs_light",
		"effects": {"light_bonus": 0.30, "armor_penalty": -0.10}},
	"MOD_07": {"id": "MOD_07", "name": "防空专精",   "desc": "空射+40%,地面-15%",      "type": "attack",   "power_mult": 1.40,
