...
# Avoid trigger words like "launcher", "anti-tank", "rocket" that get blocked by content filter
prompt = (
    ...
    "WW2 era military support soldier carrying large cylindrical shoulder weapon tube, "
    "cylindrical tube shape clearly visible resting on shoulder, "
...
tmpfile = output_dir + "/bazooka_retry2.json"
...
resp_file = output_dir + "/bazooka_resp2.json"
cmd = [
    "curl", "--http1.1", "-s",
