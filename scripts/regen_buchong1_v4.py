...
PROMPTS = {
    "enemy_ww1_m76.png": (
        ...
        "complete soldier figure standing in PERFECT strict side profile, wearing WW1-era helmet with mechanical upgrades, "
        ...
        "full body visible from head to toe, one eye only, side view, "
    ...
    "enemy_ww2_garand.png": (
        ...
        "complete soldier figure standing in PERFECT strict side profile, wearing M1 helmet with mechanical neck support, "
        "holding Garand semi-automatic rifle with gas-tube mechanism, "
        "M1 field vest with en-bloc clip holder, full body visible from head to toe, "
        "one eye only, side view, "
    ...
    "enemy_ww2_mp40.png": (
        ...
        "complete soldier figure standing in PERFECT strict side profile, wearing compact combat helmet and light armor vest, "
    ...
    "enemy_cold_rpg.png": (
        ...
        "complete soldier figure standing in PERFECT strict side profile, wearing moderate body armor with helmet, "
    ...
    "enemy_cold_sam7.png": (
        ...
        "complete soldier figure standing in PERFECT strict side profile, wearing woodland combat uniform with tactical vest, "
    ...
    "enemy_modern_javelin.png": (
        ...
        "complete soldier figure standing in PERFECT strict side profile, wearing modular plate carrier with helmet, "
    ...
    "enemy_ww2_bazooka.png": (
        ...
        "complete soldier figure standing in PERFECT strict side profile, wearing light combat uniform with helmet, "
