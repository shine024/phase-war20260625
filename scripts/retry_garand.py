...
STRICT_PREFIX = (
    ...
    "ONLY ONE EAR visible, body completely flat profile, NO front-facing torso, "
    "strictly sideways stance, legs aligned in side view."
)
...
prompt_text = (
    ...
    "COMPLETE SIDE PROFILE SOLDIER ONLY, PERFECT strict side view, "
    ...
    "ONE EYE ONLY, SIDE VIEW, torso completely flat sideways, "
...
for attempt in range(3):
    ...
    if img_url:
        ...
        out_path = os.path.join(TARGET_DIR, "enemy_ww2_garand.png")
