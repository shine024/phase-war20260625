#!/usr/bin/env python3
"""Regenerate 8 enemy sprites for 补充1 using 精灵图nano_banana2_enemy_prompts_36.md prompts."""
...
FILES = [
    # 1. enemy_ww1_m76 -> enemy_ww1_infantry_basic
    ("enemy_ww1_infantry_basic.png",
    ...
    # 2. enemy_ww1_105mm -> enemy_ww1_mortar
    ...
    # 3. enemy_ww1_mg08 -> enemy_ww1_mg_nest
    ("enemy_ww1_mg_nest.png",
    ...
    # 4. enemy_cold_rpg -> enemy_cold_btr
    ("enemy_cold_btr.png",
    ...
    # 5. enemy_cold_m14 -> enemy_cold_ak
    ("enemy_cold_ak.png",
    ...
    # 6. enemy_modern_javelin -> enemy_modern_marine
    ("enemy_modern_marine.png",
    ...
    # 7. enemy_future_howitzer -> enemy_future_drone
    ...
    # 8. enemy_ww2_mp40 -> enemy_ww2_infantry
    ("enemy_ww2_infantry.png",
