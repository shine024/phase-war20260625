#!/usr/bin/env python3
"""Regenerate 8 specific enemy sprites for 补充1 using prompts from 精灵图nano_banana2_enemy_prompts_36.md"""
...
# 8 files: (target_filename, prompt_text from 36-prompts spec)
FILES = [
